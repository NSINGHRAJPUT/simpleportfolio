...
const Education = () => {
    return <section className='education'>
        <div className='classx '>
            <h2 className='classname animate__animated animate__fadeInRight animate__delay-2s'>Class X</h2>
            <h4 className='classyear animate__animated animate__fadeInLeft animate__delay-2s'>(2012-2013)</h4>
            <h4 className='classsubject animate__animated animate__fadeInRight animate__delay-2s'>Computer Science</h4>
            <h4 className='classinstitute animate__animated animate__fadeInLeft animate__delay-2s'>Gyan Ganga International Academy, Ratanpur, Bhopal (M.P.)</h4>
            <h4 className='classaff animate__animated animate__fadeInRight animate__delay-2s'>CBSE</h4>
        </div>
        <div className='classx '>
